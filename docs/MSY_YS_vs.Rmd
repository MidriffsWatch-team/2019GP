...
catchmsy(year=year,
   ...
   l0=list(low=0.3,up=0.6,step=0),#biomass in year 1 in relation to K, Initial catch divided by highest catch
   lt=list(low= 0.01,up=0.4,refyr=2015),
   k=list(dist="unif",low=4000,up=15000), #carrying capacity; low=highest reported catch, high=highest catch*100
   r=list(dist="unif",low=0.3,up=0.6), #intrinsic growth rate based on resiliene; Low  0.05–0.5
