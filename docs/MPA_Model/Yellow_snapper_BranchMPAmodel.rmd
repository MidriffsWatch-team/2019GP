---
title: "Yellow_Snapper_BranchMPAmodel"
...
calc.harvest.vec <- function(u.out, ncells, MPA.width)  {
   ...
   if (MPA.width > 0) {   #no need to do this if there is no MPA! 
      MPA.begin <- round((ncells-MPA.width)/2)+1  #start cell of MPA in the middle of ncells 
...
MPA<-MPA.model(r=0.378136514, K=4, N0=0.00467576, u.out=0.118697178, ncells=100,
          MPA.width=5, nsteps=5, mrate=0.5)

NoMPA<-MPA.model(r=0.378136514, K=4,  N0=0.00467576, u.out=0.118697178, ncells=100,
