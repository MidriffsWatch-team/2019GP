...
```{r}
ggplot(data = merge_octopus, aes( x = year, y = catch, colour = State))+
  geom_point()+
  geom_line()+
  labs(x="Year", y="Projected catch (MT)")+
  theme_classic()+
  theme(legend.title=element_blank())+
  ggtitle("Octopus Predicted Catch 2015-2050")
