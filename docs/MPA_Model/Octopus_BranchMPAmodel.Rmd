...
```{r}
MPA.model <- function(r, K, N0, u.out, ncells, nsteps, 
                      MPA.width, mrate) {
...
MPA_octopus <- MPA.model(r=0.566, K=1202.62, u.out=0.2154, ncells=100,
          MPA.width=5, nsteps=5, mrate=0.5)

NoMPA_octopus <- MPA.model(r=0.566, K=1202.62, u.out=0.2154, ncells=100,
...
merge<-merge(MPA_octopus.df, NoMPA_octopus.df, by="year")
