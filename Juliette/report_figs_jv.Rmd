...
circle_graph <- ggplot(circle) +
  ...
  annotate(geom="text", x=1256.866, y=361405.921, label="318K MT",
              color="black") +
  annotate(geom="text", x=1253.392, y=364691.491, label="319K MT",
              color="black")+
  annotate(geom="text", x=1247.927, y=369812.271, label="321K MT",
              color="black")+
  annotate(geom="text", x=1240.207, y=375365.648, label="324K MT",
              color="black")+
  annotate(geom="text", x=1188.948, y=377850.277, label="332K MT",
              color="black")+
  xlim(1170, 1270)+
  ylim(360000, 380000)+
  theme_classic()+
  xlab("Biomass 1000 (MT)") +
  ylab("Profits 1000 (US$)")
