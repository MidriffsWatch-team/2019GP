...
circle_graph_A <- ggplot(circle_A) +
  geom_point(aes(x=Biomass_est, y=PV_est, size=Catch_est, color = Adjusted, shape = Implementation_year) ,fill ="NA")+
...
#ggsave("circles_1.jpg", width=7, height=5, dpi=300)
...
circle_graph_B <- ggplot(circle_B) +
  geom_point(aes(x=Biomass_est, y=PV_est, size=Catch_est, color = Implementation_year, shape = Adjusted) ,fill ="NA")+
  scale_shape_manual(values = c(21, 22, 24, 23))+
  guides(size= "none")+
 scale_size_continuous(range = c(10, 35)) +
 xlim(600, 2200)+
