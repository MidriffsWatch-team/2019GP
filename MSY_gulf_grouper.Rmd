...
graph <-ggplot(gulf_grouper, aes(x=Ano, y=MT))+
  geom_line(size=1)+
...
catchmsy(year=year_gulf_grouper,
                catch=catch_gulf_grouper,
    ...
    k=list(dist="unif",low=19.555,up=195.55), #carrying capacity; low=highest reported catch, high=highest catch*100
    r=list(dist="unif",low=0.025,up=0.1), #intrinsic growth rate based on resiliene 
