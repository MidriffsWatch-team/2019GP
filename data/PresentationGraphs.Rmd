...
ggplot(cummulative_Octopus, aes(x=Year, y=Biomass_est, color=Status))+
ggplot(cummulative_MT, aes(x=Year, y=Biomass_est, color=Status))+
 geom_line(size=2)+
...
ggplot(cummulative_Octopus, aes(x=Year, y=Catch_est, color=Status))+
