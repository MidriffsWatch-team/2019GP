...
KobePlot<-ggplot(Genus_pts, aes(x= bbmsy, y=ffmsy, size=catch))+
  ...
  #geom_text_repel(aes(label=Name),size=3, check_overlap=FALSE, hjust = 1, nudge_x = 0.05)+
...
#ggsave("kobe.jpg", width=8, height = 5, dpi=300)
...
kobe_MPA<-ggplot(MPA, aes(x = bbmsy, y = ffmsy)) +
  ...
  labs(title = "Fishery Status with Reserves: {closest_state} ", x = "B/BMSY", y= "F/FMSY", subtitle = "Open access eq at 0.10 B/BMSY") +
  theme_classic()+
...
kobe_no<-ggplot(NoMPA, aes(x = bbmsy, y = ffmsy)) +
  geom_point(aes(color = Year, size=3)) +
  labs(title = "Fishery Status without Reserves: {closest_state} ", x = "B/BMSY", y= "F/FMSY", subtitle = "Open access eq at 0.10 B/BMSY") +
  theme_classic()+
  scale_color_gradientn(colors = c("black","purple","orange","yellow")) +
  geom_vline(xintercept = 1, linetype="dotted", color="black") +
  geom_hline(yintercept = 1, linetype="dotted", color="black") +
...
kobe_MPA<-ggplot(MPA, aes(x = bbmsy, y = ffmsy)) +
  geom_point(aes(color = Year, size = 3)) +
  labs(title = "Fishery Status with Reserves: {closest_state} ", x = "B/BMSY", y= "F/FMSY", subtitle = "Open access eq at 0.30 B/BMSY") +
  theme_classic()+
  scale_color_gradientn(colors = c("black","purple","orange", "blue")) +
  geom_vline(xintercept = 1, linetype="dotted", color="black") +
  geom_hline(yintercept = 1, linetype="dotted", color="black") +
  transition_states(Year, transition_length = 2, state_length = 2) +
  theme_classic(base_size = 20)+
...
animate(kobe_MPA, nframes = 100, renderer = gifski_renderer("kobe_MPA0.3.gif"))

kobe_no<-ggplot(NoMPA, aes(x = bbmsy, y = ffmsy)) +
  geom_point(aes(color = Year, size = 3)) +
  labs(title = "Fishery Status without Reserves: {closest_state} ", x = "B/BMSY", y= "F/FMSY", subtitle = "Open access eq at 0.30 B/BMSY") +
  theme_classic()+
   scale_color_gradientn(colors = c("black","purple","orange","yellow")) +
  geom_vline(xintercept = 1, linetype="dotted", color="black") +
  geom_hline(yintercept = 1, linetype="dotted", color="black") +
...
animate(kobe_no, nframes = 100, renderer = gifski_renderer("kobe_no0.3.gif"))
