...
MPA_2015<-Biological.Model(df=data.0, years=20, MPA.mat = MPA.mat, MPA=1, start.year=0)
...
MPA_2015<-Biological.Model(df=data.0.1, years=20, MPA.mat = MPA.mat, MPA=1, start.year=0)
No_MPA<-Biological.Model(df=data.0.1, years=20, MPA.mat = MPA.mat, MPA=0, start.year=0)
MPA_2020<-Biological.Model(df=data.0.1, years=20, MPA.mat = MPA.mat, MPA=0, start.year=2020) #set MPA to 0, when it hits 2019 it will turn MPA areas to 0 fishing mortality 
...
MPA_2015<-Biological.Model(df=data.0.3, years=20, MPA.mat = MPA.mat, MPA=1, start.year=0)
No_MPA<-Biological.Model(df=data.0.3, years=20, MPA.mat = MPA.mat, MPA=0, start.year=0)
MPA_2020<-Biological.Model(df=data.0.3, years=20, MPA.mat = MPA.mat, MPA=0, start.year=2020) #set MPA to 0, when it hits 2019 it will turn MPA areas to 0 fishing mortality 
MPA_2025<-Biological.Model(df=data.0.1, years=20, MPA.mat = MPA.mat, MPA=0, start.year=2025)
...
write.csv(patch_2000_2035, "merged_2D_output0.1.csv")
