...
ggsave("Line2_priors.jpg", width=4, height=4, dpi=300)
...
ggsave("Biomass_Fishery_priors.jpg", width=5, height=4, dpi=300)
...
C<-ggplot(Fisheries, aes(x=Year, y=Catch_est, group= Name))+
  ...
  theme_classic(base_size = 9)+
  facet_wrap(~ Name, scales="free" , ncol=3)
ggsave("Catch_Fishery_priors.jpg", width=5, height=4, dpi=300)
...
Fishing <-ggplot(Fisheries, aes(x=Year, y=ffmsy, group= Name))+
  ...
  theme_classic(base_size = 9)+
  facet_wrap(~ Name, scales="free" , ncol=3)
ggsave("F_Fishery_priors.jpg", width=5, height=4, dpi=300)
...
initial <- read.csv(here::here("Priors_r_0.9","Genus_pts_priors.csv"))%>%
  filter(Adjusted=="IUU_0")%>%
...
#ggsave("Kobe2015_label_priors.jpg", width=4, height=3, dpi=300)
...
KobeOA_size
#ggsave("Kobe_byMRSize_priors.jpg", width=6, height=4, dpi=300)